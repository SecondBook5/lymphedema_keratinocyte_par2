#!/usr/bin/env python3
"""Regenerate the keratinocyte/PAR2 main manuscript figure."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Regenerate the keratinocyte/PAR2 main manuscript figure panel."
    )
    parser.add_argument(
        "--cohort",
...
def main() -> None:
    ...
    print("Regenerating Figure G from:", annotated)
