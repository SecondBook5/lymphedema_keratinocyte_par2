#!/usr/bin/env python3
"""Regenerate the keratinocyte state sensitivity figure."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Regenerate the keratinocyte state sensitivity figure.")
...
def main() -> None:
    ...
    print("Regenerating state sensitivity from:", annotated)
