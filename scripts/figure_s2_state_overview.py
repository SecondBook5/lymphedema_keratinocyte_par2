#!/usr/bin/env python3
"""Regenerate the keratinocyte state overview figure."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Regenerate the keratinocyte state overview figure.")
...
def main() -> None:
    ...
    print("Regenerating state overview from:", annotated)
